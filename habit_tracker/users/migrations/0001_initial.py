    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_settings', models.JSONField(blank=True, default=dict, help_text="User-specific settings stored as JSON. For example, {'theme': 'dark', 'notifications': true}.", null=True)),
